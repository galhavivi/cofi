...
import FlexOverall from '../flex-overall';

export default () => (<Styled.HomeWrapper id="home">
  <Styled.H2>Cofi | React Form Demos</Styled.H2>
  <p>View full list of react form demos from the menu navigation</p>
  <Styled.H3>Mixed Main Capabilities.</Styled.H3>
  <p>Units bellow consume the Form's context to use its data and actions</p>
  <FlexOverall />
