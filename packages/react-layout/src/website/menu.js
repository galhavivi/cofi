...
export default [{
  ...
  label: 'Sections',
  items: [
    getSubItem('sections', 'boxes', 'sections-boxes', 'Using Flex Boxes', [docs.overview, docs.section]),
    getSubItem('sections', 'grid', 'sections-grid', 'Using CSS Grid', [docs.overview, docs.section]),
  ],
}];
