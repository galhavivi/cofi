...
const ConditionalTerm = ({ value = defaultConditionalTerm, state, onValueChange }) => {
...
const LogicalTerm = ({ value = defaultLogicalTerm, state, onValueChange }) => {
  const [termState, setTermState] = useState({ options: state.options });
...
Term = ({ value, state, onValueChange }) => {
  ...
  return (<Wrapper>
    ...
    {
      type === 'CONDITIONAL' && <ConditionalTerm value={value} state={state} onValueChange={onValueChange} />
    }
    {
      type === 'LOGICAL' && <LogicalTerm value={value} state={state} onValueChange={onValueChange} />
    }
  </Wrapper>);
};
