      ...
      <footer className="nav-footer" id="footer">
        ...
        <section className="sitemap">
          ...
          <div>
            ...
            <a href={this.docUrl('contributors')}>Contributors</a>
          ...
          <div>
            ...
            <a target="_blank" href="https://github.com/galhavivi/cofi">GitHub</a>
            <a target="_blank" href="https://stackoverflow.com/questions/tagged/cofi">Stack Overflow</a>
            <a target="_blank" href="https://medium.com/search?q=cofi">Medium</a>
