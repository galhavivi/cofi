...
export function mapFieldToProps(id, model, resources) {
  ...
  // formatted the field value into the component.value (i.e field.component.ready === false) - then field is excluded
  if (isUndefined(field) || isUndefined(field.component) || !field.component.ready) {
    return {
      id,
      excluded: true,
    };
